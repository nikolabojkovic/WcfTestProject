    ...
    events : function (bar) {
      ...
      S(this.scope)
        ...
        .on('click.fndtn.topbar', '[' + this.attr_name() + '] .toggle-topbar', function (e) {
            e.preventDefault();
            //LR: next 2 lines inject a custom event handler for menu open/close
            responsiveMenuOpened = responsiveMenuOpened ? false : true;
            responsiveMenuStateChange(responsiveMenuOpened);
          self.toggle(this);
        })
